...
def main(dataset_name: str):
    ...
    train = reader.read("data/" + dataset_name + "/train.jsonl")
    valid = reader.read("data/" + dataset_name + "/valid.jsonl")

    data = train + valid

    tokens_to_add = {"transactions": ["@@MASK@@", "<START>", "<END>"], "amounts": ["<START>", "<END>"]}
